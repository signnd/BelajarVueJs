      ...
      <div class="card-group">
        <div class="card" style="width:auto;">
          ...
          <div class="card-body text-center">
            ...
            <router-link to="/Destination/rs-bimc-kuta" class="btn d-block btn-outline-primary text-wrap">Detail</router-link>
            <div class="pt-2"></div>
            <div class="row">
              <div class="col">
                <button class="btn w-100 btn-primary" data-toggle="modal"
        ...
        <div class="card" style="width:auto;">
         ...
         <div class="card" style="width:auto;">
          ...
          <div class="card-body text-center">
            ...
            <router-link to="/Destination/assist211" class="btn d-block btn-outline-primary text-wrap">Detail</router-link>
            <div class="pt-2"></div>
            <div class="row">
              <div class="col">
                <button class="btn w-100 btn-primary" data-toggle="modal"
