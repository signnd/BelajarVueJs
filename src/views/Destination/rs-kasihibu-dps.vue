<template>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">{{$translate(['RS Kasih Ibu Denpasar','RS Kasih Ibu Denpasar'])}}</li>
  </ol>
</nav>
            ...
            <div class="d-none d-lg-block col">
              ...
              <div class="card my-3">
                ...
                <div class="row align-center">
                  ...
                  <div class="col my-auto"><a href="https://g.page/KasihIbuHospital?share" target="_blank" style="color:black;">Jl. Teuku Umar No. 120, Denpasar,Bali 80114</a></div>
                </div></div>
              </div>
              <div class="card my-3">
                <div class="card-body">
                  ...
                  <div class="col my-auto"><a href="mailto:care@kih.co.id" style="color:black;">care@kih.co.id</a></div>
                  </div>
                </div>
              </div>
              <div class="card my-3">
                <div class="card-body">
                  ...
                  <div class="col my-auto"><a href="tel:+623613003030" target="_blank" style="color:black;">(+62 361) 300 3030</a></div>
                  </div>
                </div>
              </div>
              <div class="card my-3">
                <div class="card-body">
                  ...
                  <div class="col my-auto"><a href="https://kih.co.id/" target="_blank">https://kih.co.id/</a></div></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="d-block d-lg-none container">
          <div class="card my-3">
            <div class="card-body">
              <div class="row align-center">
                  <div class="col-1 mr-3"><i class="bi bi-geo-alt-fill"></i></div>
                  <div class="col-auto my-auto"><a href="https://g.page/KasihIbuHospital?share" target="_blank" style="color:black;">Jl. Teuku Umar No. 120, Denpasar,Bali 80114</a></div>
                </div></div>
          </div>
          <div class="card my-3">
            <div class="card-body">
              <div class="row align-center">
                  <div class="col-1 mr-3"><i class="bi bi-envelope-fill"></i></div>
                  <div class="col-auto my-auto"><a href="mailto:care@kih.co.id" style="color:black;">care@kih.co.id</a></div></div>
            </div>
          </div>
          <div class="card my-3">
            <div class="card-body">
              <div class="row align-center">
              <div class="col-1 mr-3"><i class="bi bi-telephone-fill"></i></div>
              <div class="col-auto my-auto"><a href="tel:+623613003030" target="_blank" style="color:black;"> (+62 361) 300 3030</a></div></div>
            </div>
          </div>
          <div class="card my-3">
                <div class="card-body">
                  <div class="row align-center">
                  <div class="col-1 mr-3"><i class="bi bi-globe2"></i></div>
                  <div class="col-auto my-auto"><a href="https://kih.co.id/" target="_blank">https://kih.co.id/</a></div></div>
                </div>
          </div>
        </div>
      </div>
...
<section class="p-4">
        ...
        <h3 class="text-center">{{$translate(['RS Kasih Ibu Denpasar','RS Kasih Ibu Denpasar'])}}</h3>
        <hr>
        <h5>{{$translate(['Visi RS Kasih Ibu Denpasar','RS Kasih Ibu Denpasar\'s Vision'])}}</h5>
        <p>
        ...
        <h5>{{$translate(['Misi RS Kasih Ibu Denpasar','RS Kasih Ibu Denpasar\'s Mission'])}}</h5>
        <ol>
...
export default {
    data() {
        return {
            images: {
                cover1: require('@/assets/rumahsakit/rs-kasihibu-dps.jpg'),
