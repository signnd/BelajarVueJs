            ...
            <div class="d-none d-lg-block col">
              ...
              <div class="card my-3">
                <div class="card-body">
                  ...
                  <div class="col my-auto"><a href="tel:(0361) 300 3030" target="_blank" style="color:black;"> (0361) 300 3030</a></div>
                  </div>
                </div>
              </div>
              <div class="card my-3">
        ...
        <div class="d-block d-lg-none container">
          ...
          <div class="card my-3">
            <div class="card-body">
              <div class="row align-center">
              <div class="col-1 mr-3"><i class="bi bi-telephone-fill"></i></div>
              <div class="col-auto my-auto"><a href="tel:(0361) 300 3030" target="_blank" style="color:black;"> (0361) 300 3030</a></div></div>
            </div>
          </div>
          <div class="card my-3">
                <div class="card-body">
