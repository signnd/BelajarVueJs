<template>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">{{$translate(['Klinik Penta Medika','Klinik Penta Medika'])}}</li>
  </ol>
</nav>
...
<section class="p-4">
        ...
        <h3 class="text-center">{{$translate(['Klinik Penta Medika','Klinik Penta Medika'])}}</h3>
        <hr>
        <h5>{{$translate(['Visi Klinik Penta Medika','Klinik Penta Medika\'s Vision'])}}</h5>
        <p>
         {{$translate([' Menjadi Rumah Sakit Unggul dan Mandiri Tahun 2024','Becoming an Excellent and Independent Hospital in 2024'])}}
        </p>
        <h5>{{$translate(['Misi Klinik Penta Medika','Klinik Penta Medika\'s Mission'])}}</h5>
        <ol>
