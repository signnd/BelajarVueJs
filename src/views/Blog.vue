    ...
    <section>
        <div class="blog" id="blog">
            <div class="container-fluid p-0">
                ...
                <h1 class="mt-5 centered text-black style fw-bold" style="font-size:3vw;">Blog</h1>
            </div>
        </div>
                ...
                <div class="card-group">
                    <div class="card" style="width:auto;">
                        ...
                        <div class="card-body">
                            ...
                            <router-link to="/About" class="btn d-block btn-outline-primary text-wrap">Lebih Lanjut
                            </router-link>
                            <div class="row">
                                <div class="col">
                                    Info Kesehatan
                            ...
                            <div class="card-body">
                                ...
                                <div class="card" style="width:auto;">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Artikel Belum Tersedia</h5>
                                        <p class="card-text">Kosong</p>
                                        <router-link to="/About" class="btn d-block btn-outline-primary text-wrap">Lebih
                                            Lanjut</router-link>
                                        <div class="col">
                                            Info
                                        </div>
